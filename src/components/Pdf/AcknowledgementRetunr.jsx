              ...
              <td colSpan="5">
                <div className="d-flex flex-row justify-content-between">
                  <div className="d-flex flex-column">
                    ...
                    <b>
                      Address 1:-
                      {!customerAddress1 ? "" : customerAddress1.toUpperCase()}
                    </b>
                    <b>
                      Address 2:-
                      {!customerAddress2 ? "" : customerAddress2.toUpperCase()}
                    </b>
              ...
              <td colSpan="5" className="text-left">
                <div className="d-flex flex-column">
                  ...
                  <b>
                    ...
                    entire value of the products and not just the limited to the
                    Damage Protection Amount collected.
                  </b>
                  <b>
