                ...
                <div className="table">
                  <table className="table table-bordered inner-table border-dark text-center">
                    ...
                    <tbody>
                      ...
                      <tr className="text-end" style={{ fontSize: "7px" }}>
            ...
            <tr>
              <td colSpan="5" className="text-center">
                <b>
                  ...
                  Thank you for shopping at Titan Company. You can also write to
                  us at customercare@titan.co.in " E & OE
                </b>
              </td>
            </tr>
            <tr>
              ...
              <td colSpan="5">
                <div className="d-flex flex-column">
                  ...
                  <b>
                    ...
                    “Company”) provides you an option to rent Tanishq jewellery
                    products as selected in the Booking-cum-Advance Receipt
                    mentioned in the overleaf, subject to the following Terms
                    and Conditions (“Terms”). These Terms create a legally
                  ...
                  <b>
                    1.2. This jewellery rental service is available on a “First
                    Come First Serve” basis.
                  </b>
                  <b>
                    1.3. Rental jewellery is available for 4-day or 8-day rental
                    period (pick-up date and return date included). You will
                    accordingly be charged applicable rental fee when you place
                    your advance booking at the store.
                  </b>
                  <b>
                    1.4. At no time Products worth more than Rupees Thirty lakhs
                    will be permitted for taking on rent.
                  </b>
                  <b>
                    1.5. At the time of booking, you must specify the rental
                    period and the date on which you will collect the jewellery
                    from the store.
                  </b>
                  <b>
                    1.6. On the start date of the rental period as stated during
                    the booking, you must visit the store in person to collect
                    the product. No home deliveries will be made, and no other
                    person in place of you will be permitted to collect the
                    jewellery.
                  </b>
                  <b>
                    1.7. The rented jewellery is strictly for personal use only
                  ...
                  <b className="mb-2">
                    ...
                    to provide the selected jewellery on the specified date due
                    to any reasons directly attributable to Titan, Titan will
                    refund the rental fees or provide you with an alternative
                    jewellery item on rent of an equal or greater value at no
                    additional cost. The refund of rental fee or providing an
                    alternative option will be Titan’s sole liability and your
                    sole remedy and Titan will in no event be liable for any
                    other damages whatsoever.
                  </b>
                  <b>2. Cancellation</b>
                  <b>
                    2.1. In the event of cancellation of the jewellery rental
                    service booking or failure to collect the selected jewellery
                    on the specified date or any time during the rental period
                    selected, you will be charged cancellation charges as per
                    the below mentioned table: Time of cancellation Cancellation
                    Charges (as % of rental fee) 14 days prior to the start date
                    0% 7-13 days before the start date 25% Before 7 days but not
                    on or after start date 50% On or after start date 100%
                  </b>
                  <b>
                  ...
                  <b>
                    ...
                    store from where it was collected on the return date agreed.
                  </b>
                  <b>
                    3.2. The jewellery items must be re-packaged in its original
                    jewellery box. You will be provided with a proof that you
                    delivered the package and without the receipt you can be
                    held responsible if jewellery items are not returned to
                    Titan.
                  </b>
                  <b>
                    3.3. You will be required to return the product at the store
                    in person and you cannot assign others to return the
                  ...
                  <b>
                    ...
                    extend your rental period by contacting the store. If Titan
                    is able to accommodate your request, Titan will provide a
                    revised return schedule which will be for a maximum of 4
                    additional days beyond the original rental duration, subject
                    to the availability of product and an additional cost.
                  </b>
                  <b>
                    ...
                    the charges and fees Titan may levy under Clause 4 of these
                    Terms, Titan shall have the unfettered right to forthwith
                    take any action or recourse available under law against you.
                  </b>
                  <b className="mt-3">
                  ...
                  <b>
                    ...
                    products. The rental fees are exclusive of applicable taxes
                  ...
                  <b>
                    ...
                    discretion, to determine the retail value of the jewellery,
                    and to require a Damage Protection Amount calculated in
                    accordance with Titan’s assessment criteria.
                  </b>
                  <b>
                    4.4. The Damage Protection Amount (less any applicable fees
                    or charges due) will be refunded upon return of the
                    jewellery on the specified date subsequent to inspection and
                    quality checks. If Titan determines that the jewellery
                    returned is in the same condition as when delivered to you,
                    Titan will refund the Damage Protection Amount no earlier
                    than 10 days from the date of receipt of the jewellery
                    product.
                  </b>
                  <b>
                    4.5. If, however Titan determines that the jewellery
                    returned is not as per the original condition, Titan shall
                    have the right to make deductions from the Damage Protection
                    Amount for the cost of repair or cleaning. In the event of
                    damage to any jewellery item that is beyond repair or in the
                    event of non-return of product on the specified date, in
                    addition to forfeiting the entire Damage Protection Amount,
                    Titan reserves the right to charge you up to 100% of the
                    value of the jewellery item as per the rate mentioned in the
                    Booking-cum-Advance Receipt in the overleaf. The amount to
                    be charged shall be at Titan’s sole discretion based on
                    Titan’s assessment of the damage.
                  </b>
                  <b>
                  ...
                  <b>
                    4.7. If you do not return the rented jewellery to the store
                    by the specified return date, late fees will be assessed for
                    every extra day at a rate decided by Titan (exclusive of
                    additional taxes and fee applicable) till the date of actual
                    return of the jewellery to the store. Titan reserves the
                    right to deduct late fees from the Damage Protection Amount.
                  </b>
                  <b className="mt-3">5. Care of Jewelry</b>
                  <b>
                    5.1. You acknowledge that each jewellery item rented from
                    Titan is a high value item and you covenant to treat it and
                    handle it with the utmost of care, as if it were your own.
                  </b>
                  <b>
                  ...
                  <b>
                    6.2. You will be required to submit necessary documents and
                    information at the time of booking. Identity/ address proof,
                    bank account details and PAN card are mandatory to be
                    provided at the time of booking.
                  </b>
                  <b>
                    6.3. All information provided by you must be true, accurate,
                    current and complete. Titan reserves the right to confirm
                    and validate the information and other details provided by
                    you at any point in time. Further, Titan also reserves the
                    right to ask for additional information in certain cases. If
                    upon confirmation, your details are found to be false or
                    incorrect (partially or completely) or if Titan has
                    reasonable grounds to suspect that such information is
                    false, inaccurate, incomplete, not current, Titan reserves
                    the right to refuse to provide you the jewellery rental
                    services. If you have already taken the jewellery on rent,
                    Titan reserves the right to cancel your rental at any time
                    in its sole discretion. Immediately upon cancellation of
                    your rental for any reason, you shall return all jewellery
                    immediately. All rental fees are non-refundable.
                  </b>
                  <b>
                    ...
                    placement, or rejection of rental, adjustments in the Damage
                    Protection Amount, etc.
                  </b>
                  <b>
                    6.5. In case of any change in contact or address details or
                    any other details given, you shall immediately contact the
                    store for effecting the changes, as may be applicable. Such
                    modifications made shall be subject to the satisfaction and
                    discretion of Titan.{" "}
                  </b>
                  <b>
                    6.6. Nothing in these Terms, whether express or implied, is
                    intended to or shall confer you with any ownership or title
                    or any other rights in the jewellery products taken on rent
                    by you pursuant to availing the rental services.{" "}
                  </b>
                  <b>
                    6.7. Any payments to be made shall be made only through
                    credit / debit cards, NEFT/ RTGS or through local cheques in
                    favour of “Titan Company Limited”. In case of cheque
                  ...
                  <b>
                    6.11. In no event will Titan or its affiliates or agents be
                    liable to you or any third party including without
                    limitation for any indirect, consequential, exemplary,
                    incidental, special or punitive damages, including, without
                    limitation, loss of goodwill, damages for loss, service
                    interruptions and procurement of substitute services, even
                    if Titan has been advised of the possibility of such damages
                    and the maximum liability of Titan under any circumstance
                    whatsoever shall be limited to the rental fee paid by you.
                  </b>
                  <b>
                    6.12. In no event shall Titan be liable for any failure or
                    delay in performance of its obligations hereunder if such
                    failure or delay is due to causes beyond reasonable control
                    including, but not limited to acts of God, fire or
                    explosion, war, invasion, riot, or other civil unrest,
                    governmental laws, orders, restrictions, actions, embargoes,
                    or blockages, epidemics, pandemics, national or regional
                    emergency, failure of common carriers, strikes, lockouts,
                    labour trouble, or other industrial disturbances. It is at
                    the sole discretion of Titan to provide any service during
                    any Force Majeure period.
                  </b>
                  <b>
                    6.13. Titan reserves the right to alter, amend, add, or
                    delete part or whole of the services or these Terms without
                    prior notice.
                  </b>
                  <b>
                    6.14. Titan reserves the right to suspend or discontinue the
                    jewellery rental services at any time.
                  </b>
                  <b>
                  ...
                  <b className="mt-4">
                    ...
                    residing at
                    ____________________________________________[address] hereby
                    declare and confirm that I have read, understood, and agree
                    to all Terms and Conditions as detailed above.
                  </b>
